...
\end{align}
Thus \(Q^k_{X,i},Q^m_{X,i}\) are probability measures and \(\xi^k_{X,i},\xi^m_{X,i}\) are their Radon--Nikodym densities. The logarithms in the coordinate formulas below apply only to the densities.
