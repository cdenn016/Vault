...
space is where $\theta$ lives, indexing the generative kernel; the Fisher
metric of the likelihood $\theta\mapsto p_\theta(o\given X)$ is a Riemannian
metric on \emph{that}, and its dimension is the dimension of $\theta$, which
has no relation to $n=NK$. Finally, the contextual base $\mathcal C$ indexes
law-bundle sections. Once a connection and a statistical section are chosen,
