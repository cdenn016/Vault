...
\propositionheading{Product equivalence is an admitted, not an automatic, scale premise}
\label{prop:rg-product-equivalence-not-preserved}
...
\theoremheading{Hoeffding assembly is an exact finite-network action isomorphism}
\label{thm:rg-hoeffding-action-isomorphism}
...
\propositionheading{Radon--Nikodym covariance of the nonlinear interaction step}
\label{prop:rg-interaction-rn-gauge-covariance}
