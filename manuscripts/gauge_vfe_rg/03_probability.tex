...
\medskip
\propositionheading{Dominating measure for a mixed coordinate}{prop:prob-mixed-coordinate-dominating-measure}
...
\medskip
\hypothesisheading{Regular observation, support, and log-integrability}{hyp:prob-regular-observation}
For fixed $X$, the observation satisfies $o\in\mathsf O_{\theta,X}^{\mathrm{reg}}$ under the regular-conditional convention above, and
\begin{equation}
0<p_\theta(o\given X)<\infty,
\qquad
