...
\(\sigma_0:\mathcal C_0\to \mathscr P_G|_{\mathcal C_0}\) and restrict each local frame
...
global triviality of \(\mathscr P_G\) is inferred. The corresponding
...
trivialization of bundles associated to the same $\mathscr P_G$; it does not replace the
