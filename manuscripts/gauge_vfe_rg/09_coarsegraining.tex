...
\begin{sciencetable}[htbp]{Status register for Chapter~\ref{ch:coarsegraining}. Numerical entries were computed with \texttt{numpy} in double precision at seed $20260728$; computation corroborates the stated proofs and is never offered in place of one.}
\begin{tabular}{p{0.29\textwidth} p{0.15\textwidth} p{0.44\textwidth}}
\toprule
