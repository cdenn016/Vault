...
\end{equation}
The posterior information matrix and vector are assembled from the initial law, \cref{eq:linear-gaussian-information-blocks}, and the fixed observation factor. In particular, the observation contributes
\begin{equation}
