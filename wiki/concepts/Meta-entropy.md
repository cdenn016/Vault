...
- It connects the transformer to classical [[degroot-1974-consensus|consensus]] / [[friedkin1990-social-influence-opinions|opinion-dynamics]] models through the solvable Gaussian case, where a "consensus transition" becomes a question about susceptibility and symmetry breaking.
...
> [!note] Editorial: Cross-manuscript consistency restored (2026-06-20, PIFB round-8 review). A deep adversarial pass on [[participatory-it-from-bit]] found that PIFB's two cross-references to the holonomy-frustration conjecture had dropped its load-bearing hypothesis — both attributed a residual meta-entropy at $T_{\mathrm{meta}}\to0$ to nontrivial holonomy *alone*. As this page and [[meta-entropy-manuscript]] state (Details, "Gauge sector and holonomy frustration"), holonomy is **not** sufficient: "nonzero holonomy does not by itself produce a residual entropy ... [it] is a property of the ground-state degeneracy, not of holonomy alone, and typically needs a compact or regulated sector." PIFB was corrected to require **both** conditions (nontrivial holonomy on extensively many independent plaquettes *and* an extensive ground-state degeneracy of a regulated belief sector). No change was needed here — the wiki statement was already correct; round-8 brought PIFB back into agreement with it.
...
- [[friston-2017-active-inference-process-theory|friston-2017-active-inference-process]], [[parr-2022-active-inference]] — active-inference reading of inverse temperature / precision, lifted here from policies to belief configurations.
- [[caticha-2019-entropic-dynamics-qm|caticha-2019-entropic-dynamics]] — physics precedent for belief dynamics as entropic/maximum-entropy inference on a Fisher-metric configuration space.
