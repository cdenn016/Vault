...
The Cartan decomposition separates rotations from symmetric directions and supports the quotient/AIRM covariance geometry. This does not make a positive frame conditioner a full-$\mathrm{GL}(K)$ invariant metric or a Fisher natural gradient. Belief-side full-SPD AIRM and Gaussian Fisher facts remain valid. [[gl-k-attention-2026-07-09-review-revision]]
...
- [[bonnabel-2009-spd-fixed-rank|bonnabel-sepulchre-2009-psd-fixed-rank]] — geometry of the low-rank (degenerate-covariance) boundary of the cone.
...
- [[nickel-2017-poincare-embeddings|nickel-kiela-2017-poincare-embeddings]] — hierarchy is most faithfully represented on a curved manifold (resonance with the nonpositively-curved cone).
