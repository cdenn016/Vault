...
> Constructor theory is the contrast class the project explicitly defines itself against. Both programs are "information-first," but they differ sharply on what grounds information: Deutsch and Marletto ground it in *objective, agent-independent* possibility/impossibility facts about physical transformations, whereas [[participatory-it-from-bit]] grounds objectivity in *consensus among coupled agents* — information is fundamentally perspectival, and shared structure is an achievement of inter-agent [[Parallel transport]] rather than a pre-given physical invariant. Citing Deutsch–Marletto lets the manuscript stake out its participatory position: it accepts the "it from bit" priority of information ([[wheeler-1990-it-from-bit]]) but rejects locating information in observer-independent physical possibility, siding instead with relational and QBist accounts ([[rovelli-1996-relational-qm]], [[fuchs2014-qbism-locality|fuchs-2014-qbism]], [[adlam-2022-cross-perspective|adlam-rovelli-2022-cross-perspective]]), with [[Holonomy]] measuring where that construction fails to globalize.

## Cross-links
- Concepts: [[fuchs-2017-participatory-realism|Participatory Realism]], [[Participatory realism (it from bit)|It from Bit]], [[Information Geometry]], [[Group equivariance|Gauge Equivariance]], [[Variational free energy|VFE Functional]], [[Parallel transport]], [[Holonomy]], [[Agents as fibre-bundle sections]], [[Participatory realism (it from bit)]]
- Related sources: [[wheeler-1990-it-from-bit|wheeler-1989-it-from-bit]], [[wheeler-1990-it-from-bit]], [[marletto-2021-constructor-reality]], [[rovelli-1996-relational-qm]], [[fuchs2014-qbism-locality|fuchs-2014-qbism]], [[adlam-2022-cross-perspective|adlam-rovelli-2022-cross-perspective]]
- Manuscript/Project: [[Participatory realism (it from bit)|PIFB]], [[VFE Transformer Program]], [[GL(K) gauge-equivariant attention|GL(K) Attention]]
