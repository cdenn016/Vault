...
In the PIFB reading, the positional/syntactic head split maps onto the decomposition of the coupling: positional heads (fixed-offset attention) are the abelian gauge-frame / distance-prior part (the RoPE and ALiBi mechanisms of [[su2024roformer|su-2021-roformer-rope]] and [[press2022-alibi|press-2021-alibi]]), while relation-specific syntactic heads are the content-driven KL coupling between beliefs. This grounds the head-role reading under [[Mechanistic interpretability of attention]].

## Cross-links
- Concepts: [[Multi-Head Attention]], [[Attention Mechanism|Attention Mechanisms]], [[Transformer Architecture]], [[Parallel transport|Gauge Transport]], [[Mechanistic interpretability of attention]]
- Related sources: [[vaswani-2017-attention]], [[louizos-2018-l0-regularization|louizos-2018-l0]], [[olsson-2022-induction-heads]], [[clark-2019-bert-attention]]
- Manuscript/Project: [[gl-k-attention|GL(K) Attention Manuscript]], [[VFE Transformer Program]]
