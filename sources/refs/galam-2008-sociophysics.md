...
This work is the canonical entry point for the **social-physics** strand of the project — the modeling tradition that treats interacting opinion-holding agents as a physical many-body system. It sits alongside the other consensus-dynamics references the project draws on ([[degroot-1974-consensus]], [[friedkin-johnsen-1990]], [[deffuant-2000-bounded-confidence]], [[hegselmann-krause-2002]]) and supplies the discrete-spin, majority-rule counterpart to their continuous-averaging accounts of belief updating.
